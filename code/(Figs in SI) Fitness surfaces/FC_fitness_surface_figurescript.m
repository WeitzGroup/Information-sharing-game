...
set(xlab,'position',get(xlab,'position') - [0 0 0]);
set(gca, 'FontSize', 20)
...
title('FC fitness','fontsize',24,'interpreter','latex')
colormap('gray')

saveas(gcf,'f_FC_kappa=1.jpg')
crop('f_FC_kappa=1.jpg')

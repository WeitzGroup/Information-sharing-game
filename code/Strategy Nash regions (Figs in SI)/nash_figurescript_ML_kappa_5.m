...
% when kappa=5. Each grid point with fineness .001 in the parameter space
...
%
close all
ML_nash(ML_nash > 0) = 30; % color scheme for ML
...
text(.56, .91, 'Majority Logic (A,B)','interpreter','latex','fontsize',20)
...
saveas(gcf,'nash_ML_kappa=5.jpg')
crop('nash_ML_kappa=5.jpg')
